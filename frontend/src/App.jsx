                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-6 border-t border-slate-100">
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 text-sm font-bold bg-slate-900 text-white px-5 py-2.5 rounded-full hover:bg-slate-700 transition-colors"
                    >
                      View Paper <ArrowUpRight size={16} />
                    </a>
                  </div>
                </Motion.div>
              ))}
